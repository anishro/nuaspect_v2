...
export default function AboutTheTeam() {
  return (
    <div className="relative min-h-screen pt-32 pb-16 px-4 md:px-8 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute left-[15%] bottom-[10%] w-[55vw] h-[55vw] max-w-[450px] max-h-[450px] opacity-30 z-0">
        <FerrisWheel />
      </div>
      ...
      >
        ...
        <p className="font-serif italic text-lg md:text-xl text-brand-accent-sage tracking-wide mb-8">
          "Clinicians, researchers, and systems architects."
        </p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-brand-charcoal/70 text-sm md:text-base leading-relaxed max-w-md mx-auto">
            Our biographies, published journals, clinical background portfolios, and architectural records are being compiled by our content directors.
          </p>
        </div>

        <div className="mt-8 inline-flex items-center gap-2 text-xs font-mono tracking-widest text-brand-charcoal/50">
          <Construction className="w-4 h-4 animate-spin" style={{ animationDuration: '7s' }} />
          <span>NUASPECT // CORE TEAM</span>
        </div>
      </motion.div>
    </div>
  );
